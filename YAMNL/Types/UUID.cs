namespace YAMNL.Types
{
    public struct UUID : IEquatable<UUID>
    {
        ...
        public bool Equals(UUID uuid) => MostSignificantBits == uuid.MostSignificantBits && LeastSignificantBits == uuid.LeastSignificantBits;
        ...
        public override string ToString() =>
            ...
            GetDigits(MostSignificantBits >> 32, 8) + "-" +
